    ...
    public class Particle : StoryboardObjectGenerator
    {
        ...
        public override void Generate()
        {
            ...
            { 
                ...
                var startPosition = new Vector2(Random(-800, 640), 480+100);
                var endPosition = startPosition + new Vector2(Random(600, 1000), -(480+200));
                ...
                //}
                particle.Move(0, loopDuration, startPosition, endPosition);
